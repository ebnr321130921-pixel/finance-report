...
h1 { font-size: 22px; font-weight: 600; margin: 0 0 18px 0; color:#333; }
...
def plot_monthly(sp_arr, q_arr, title1, title2, ylimit, is_overall=False):
    ...
    if title2:
        ax.set_title(f"{title1}\n{title2}", fontsize=7, color="#444")
    else:
        ax.set_title(title1, fontsize=7, color="#444")
...
def plot_annual_summary(ann_q, ann_s, years20):
    ...
    ax.set_title("Annual Return Summary (20 years)", fontsize=8, color="#444")
...
# =========================================
def build_analysis_html(df, monthly_map, ann_q, ann_s, years20):
    html = []
