...
RELATIVE_FORECAST_PATH = DATA_DIR / "relative_forecast_log.csv"

SUMMARY_TEXT_PATH  = DATA_DIR / "market_summary_text.txt"
SUMMARY_TABLE_PATH = DATA_DIR / "market_summary_table.csv"

# =========================================================
# [ANCHOR: PATH_DIRECTION_RETURN_LOG]
# Direction Forecast × Actual Return Log
# =========================================================
DIRECTION_FORECAST_PATH = DATA_DIR / "forward_direction_forecast_log.csv"  # 既にあるなら重複定義しない
DIRECTION_RETURN_LOG_PATH = DATA_DIR / "direction_forecast_return_log.csv"
...
relative_df  = pd.read_csv(RELATIVE_FORECAST_PATH)
...
# =========================================================
# [ANCHOR: PREP_RAW_PRICE_INDEX]
# Prepare raw price lookup (Close/level data in raw)
# =========================================================
raw_price = raw.set_index("date")
...
direction_view = (
    "本モデルでは回帰係数（regression_coefficients_latest）および\n"
    "相対予測ログ（relative_forecast_log）を用いて、\n"
    "市場および資産の方向性バイアスを評価しています。\n"
    "（forward direction forecast は現行パイプラインでは未使用）"
)

# =========================================================
# [ANCHOR: BUILD_EVALUATION_VIEW]
# Past Evaluation View for Viewer
# =========================================================
