...
if TREND_PATH.exists():
    ...
    if decision_cdf is not None:
        ...
        decision_chart_html = (
            ...
            # --- Weekly thresholds ---
            .replace("__QQQ_1W_P95__", js_arr(sigma_sync["qqq_1w_p95"]))
            .replace("__QQQ_1W_P99__", js_arr(sigma_sync["qqq_1w_p99"]))
            .replace("__SP_1W_P95__",  js_arr(sigma_sync["sp_1w_p95"]))
            .replace("__SP_1W_P99__",  js_arr(sigma_sync["sp_1w_p99"]))

            # --- Monthly thresholds ---
            .replace("__QQQ_1M_P95__", js_arr(sigma_sync["qqq_1m_p95"]))
            .replace("__QQQ_1M_P99__", js_arr(sigma_sync["qqq_1m_p99"]))
            .replace("__SP_1M_P95__",  js_arr(sigma_sync["sp_1m_p95"]))
            .replace("__SP_1M_P99__",  js_arr(sigma_sync["sp_1m_p99"]))
        )
