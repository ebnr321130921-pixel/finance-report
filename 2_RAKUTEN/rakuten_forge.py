...
def build_weekly_trend(records):
    ...
    weeks = pd.period_range(end=latest_week, periods=20, freq="W-MON")
...
def build_monthly_trend(records):
    ...
    months = pd.period_range(end=latest_month, periods=20, freq="M")
